...
import UploadHandler from '../../src/uploadHanfler.js'
...
describe('Routes test suite', () => {
  ...
  describe('handler', () => {
    test('given an inexistent rout it should choose default route', async () => {
      const routes = new Routes()
      const params = {
        ...defaultParams
      }
      ...
      expect(params.res.end).toHaveBeenCalledWith('hello')
    })
  ...
  describe('post', () => {
    test('it should vaidate post route workflow', async () => {
